...
### Currently accepted
Current accepted work: **#211 Add reusable non-video layers to the layout canvas**. A PR must complete that issue's Acceptance through the normal product workflow.
